...
namespace GuardaCapitaldaCultura2027.Controllers
{
    public class TuristasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TuristaId,Nome,Apelido,Contacto,NIF,Email,Password")] Turista turista)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TuristaId,Nome,Apelido,Contacto,NIF,Email,Password")] Turista turista)
        {
